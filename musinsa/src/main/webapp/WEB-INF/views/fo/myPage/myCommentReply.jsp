...
<html lang="ko">
    ...
    <meta id="fbOgUrl" property="og:url" content="http://www.musinsa.com/member/comment/reply" />
    <!--// 페이스북 오픈 그래프 메타태그 -->
    ...
    <script>
        ...
        var uiConfig = {
            ...
            currentDate: '2023-04-12 21:52:30'
        };
