...
<!--                <input type="hidden" name="goods_est" value=""> // TODO 사용여부 확인 후 삭제-->
  ...
  <script type="text/javascript"
    ...
    <script>
        var params = {"goodsNo":2710997,"orderOptNo":176329232,"estimateNo":0,"estimateType":"photo","containEstimateType":true,"photoReview":true} || {};
        var reviewState = {
            isPhotoReview: true || false,
            satisfactionListCount: 5 || 0,
            bodySize: {"sizeHeightStart":100,"sizeHeightEnd":220,"sizeWeightStart":30,"sizeWeightEnd":150} || {},
            // imageCount: 0,
            isBeautyGoods : false || false,
            reviewText : "\uC0C1\uD488 \uC0AC\uC9C4 \uD6C4\uAE30" || '',
            itemCategoryCode : "007001001" || '',
