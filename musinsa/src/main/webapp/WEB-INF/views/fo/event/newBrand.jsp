...
<!-- //유사 이미지 상품 검색 --><script type="text/javascript" src="//static.msscdn.net/skin/m_musinsa/js/jquery.lazyload.min.js"></script>
<script type="text/javascript">


$(document).ready(function(){
   $(".htmlCopyBox").removeClass("active");
});
function set(state, brand, page) {
	if(page != ""){
		var ff = document.brand_event_search_frm;
...
<script type="text/javascript">
var brand_event_page = 2;
var brand_event_state = "20";
var brand_event_brand = "";
var brand_event_total = "33";
...
function getMoreList(){
	$.ajax({
		url: "/app/brand_event/get_more_brand_event_list",
		data: 'page=' + brand_event_page + '&brand=' + brand_event_brand +'&state=' + brand_event_state,
		success: function(msg){
			if(msg) {
				brand_event_page++;
				$("#productBox").append(msg);

				if($("#productBox > li").length == brand_event_total) {
